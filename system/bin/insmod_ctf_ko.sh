...
if [[ "$fix_ttl" == "0" ]] || [[ "$fix_ttl" == "" ]]; then
    /system/bin/insmod /system/bin/kmod/ctf.ko

elif [[ "$fix_ttl" == "1" ]] || [[ "$fix_ttl" == "64" ]]; then
    /system/bin/insmod /system/bin/kmod/ctf_ttl_set_64.ko

elif [[ "$fix_ttl" == "65" ]]; then
    /system/bin/insmod /system/bin/kmod/ctf_ttl_set_65.ko

elif [[ "$fix_ttl" == "128" ]]; then
    /system/bin/insmod /system/bin/kmod/ctf_ttl_set_128.ko
